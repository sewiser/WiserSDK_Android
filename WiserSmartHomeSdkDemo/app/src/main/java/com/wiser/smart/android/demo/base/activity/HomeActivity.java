...
import com.wiser.smart.android.demo.base.presenter.HomePresenter;
import com.wiser.smart.android.demo.base.utils.ActivityUtils;
import com.wiser.smart.android.demo.base.view.IHomeView;
import com.wiser.smart.android.demo.family.activity.FamilyEmptyActivity;
...
public class HomeActivity extends BaseActivity implements IHomeView {
    ...
    protected void initView() {
        ...
        mIvMyDevice.setImageDrawable(VectorDrawable.getDrawable(WiserSdk.getApplication(), R.drawable.ty_mydevice));
        ...
        mIvHomeCenter.setImageDrawable(VectorDrawable.getDrawable(WiserSdk.getApplication(), R.drawable.ty_home_center));
    ...
    public void onItem(int id) {
        switch (id) {
            case HomePresenter.TAB_MY_DEVICE:
                ...
                mIvMyDevice.setColorFilter(mFuncBarTextSelectColor);
                mIvMyDevice.setImageDrawable(VectorDrawable.getDrawable(WiserSdk.getApplication(), R.drawable.ty_mydevice_selected));
            ...
            case HomePresenter.TAB_PERSONAL_CENTER:
                ...
                mIvHomeCenter.setImageDrawable(VectorDrawable.getDrawable(WiserSdk.getApplication(), R.drawable.ty_home_center_selected));
                mFragmentContainer.setCurrentItem(idToPosition(id), true);
                break;
