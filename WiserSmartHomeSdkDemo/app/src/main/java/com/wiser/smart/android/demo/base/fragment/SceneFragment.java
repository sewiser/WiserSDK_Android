...
import com.wiser.smart.android.demo.scene.adapter.SmartAdapter;
...
public class SceneFragment extends BaseFragment implements ISceneListFragmentView, View.OnClickListener {
    ...
    private void initAdapter() {
        mSceneAdapter = new SmartAdapter(getActivity(), SceneListPresenter.SMART_TYPE_SCENE);
        mAutoAdapter = new SmartAdapter(getActivity(), SceneListPresenter.SMART_TYPE_AUTOMATION);
