...
import com.wiser.smart.android.base.event.NetWorkStatusEvent;
import com.wiser.smart.android.base.event.NetWorkStatusEventModel;
...
import com.wiser.smart.android.demo.base.fragment.DeviceListFragment;
...
import com.wiser.smart.android.demo.config.AddDeviceTypeActivity;
import com.wiser.smart.android.demo.config.CommonConfig;
import com.wiser.smart.android.demo.device.CommonDeviceDebugActivity;
import com.wiser.smart.android.demo.device.SwitchActivity;
import com.wiser.smart.android.demo.device.common.CommonDeviceDebugPresenter;
import com.wiser.smart.android.mvp.presenter.BasePresenter;
import com.wiser.smart.home.sdk.WiserHomeSdk;
import com.wiser.smart.home.sdk.api.IWiserHomeStatusListener;
...
//                                //重置说明
    ...
    public void getDataFromServer() {
        WiserHomeSdk.getHomeManagerInstance().queryHomeList(new IWiserGetHomeListCallback() {
            ...
            public void onSuccess(List<HomeBean> homeBeans) {
                ...
                WiserHomeSdk.newHomeInstance(homeId).registerHomeStatusListener(new IWiserHomeStatusListener() {
                    @Override
            ...
            public void onError(String errorCode, String error) {
                WiserHomeSdk.newHomeInstance(Constant.HOME_ID).getHomeLocalCache(new IWiserHomeResultCallback() {
                    @Override
                    public void onSuccess(HomeBean bean) {
    ...
    private void unBindDevice(final DeviceBean deviceBean) {
        ...
        WiserHomeSdk.newDeviceInstance(deviceBean.getDevId()).removeDevice(new IResultCallback() {
            @Override
