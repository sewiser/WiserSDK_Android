...
import com.wiser.smart.android.demo.device.SwitchBean;
import com.wiser.smart.android.demo.base.utils.ProgressUtil;
import com.wiser.smart.android.demo.base.utils.ToastUtil;
import com.wiser.smart.android.demo.device.ISwitchView;
import com.wiser.smart.android.demo.device.common.DpCountDownLatch;
...
public class SwitchPresenter extends BasePresenter implements IDevListener {
    ...
    private void initData() {
        ...
        if (mDevBean == null) {
            ...
            boolean open = (boolean) WiserHomeSdk.getDataInstance().getDp(mDevBean.getDevId(), SwitchBean.SWITCH_DPID);
    ...
    private void sendCommand() {
        ...
        mWiserDevice.publishDps(JSONObject.toJSONString(hashMap), new IResultCallback() {
            @Override
