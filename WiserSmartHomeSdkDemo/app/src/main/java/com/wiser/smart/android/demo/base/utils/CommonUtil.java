...
import com.wiser.smart.android.base.database.StorageHelper;
...
public class CommonUtil {
    ...
    public static PowerManager.WakeLock acquireLock(Context context) {
        if (wakeLock == null || !wakeLock.isHeld()) {
            ...
            wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "wiser");
    ...
    public static int loadLocalDrawable(Context context, String name) {
        int resID = context.getResources().getIdentifier(name, "drawable", "com.wiser.smart");
        return resID;
    }
