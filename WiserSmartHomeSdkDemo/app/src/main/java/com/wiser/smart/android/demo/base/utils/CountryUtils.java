...
import com.wiser.smart.android.base.bean.CountryBean;
import com.wiser.smart.android.common.utils.L;
import com.wiser.smart.android.common.utils.TyCommonUtil;
import com.wiser.smart.android.demo.login.CountryViewBean;
import com.wiser.smart.android.demo.base.widget.contact.ContactItemInterface;
...
public class CountryUtils {
    ...
    public static List<ContactItemInterface> getSampleContactList() {
        ...
        Iterator iter = null;
        if (TyCommonUtil.isZh(WiserSdk.getApplication())) {
