...
import com.wiser.smart.android.demo.base.utils.ViewUtils;
import com.wiser.smart.android.demo.base.widget.circleprogress.CircleProgressView;
...
public class ECBindActivity extends BaseActivity implements IECBindView {
    ...
    private void initView() {
        ...
        VectorDrawable drawable = VectorDrawable.getDrawable(WiserSdk.getApplication(), R.drawable.add_device_fail_icon);
    ...
    public void showBindDeviceSuccessTip() {
        ViewUtils.setTextViewDrawableLeft(WiserSdk.getApplication(), mDeviceBindSussessTip, R.drawable.ty_add_device_ok_tip);
    }

    @Override
    public void showDeviceFindTip(String gwId) {
        ViewUtils.setTextViewDrawableLeft(WiserSdk.getApplication(), mDeviceFindTip, R.drawable.ty_add_device_ok_tip);
    }

    @Override
    public void showConfigSuccessTip() {
        ViewUtils.setTextViewDrawableLeft(WiserSdk.getApplication(), mDeviceInitTip, R.drawable.ty_add_device_ok_tip);
    }
