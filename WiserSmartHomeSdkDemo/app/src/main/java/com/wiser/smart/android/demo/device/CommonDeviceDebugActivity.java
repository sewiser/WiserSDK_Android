...
//                        ObjectAnimator.ofInt(testScroll, "scrollY", delta, bottom).setDuration(500).start();
    ...
    public void logSuccess(DpLogBean logBean) {
        ...
        msg += "\n";
        msg += getString(R.string.time_dp_start) + " " + WiserUtil.formatDate(logBean.getTimeStart(), "yyyy-MM-dd hh:mm:ss");
        msg += "\n";
        msg += getString(R.string.time_dp_end) + " " + WiserUtil.formatDate(logBean.getTimeEnd(), "yyyy-MM-dd hh:mm:ss");
        msg += "\n";
