package com.wiser.smart.android.demo.device.common;
...
import com.wiser.smart.android.demo.base.bean.AlertPickBean;
import com.wiser.smart.android.demo.base.utils.DialogUtil;
import com.wiser.smart.android.demo.base.utils.SchemaMapper;
import com.wiser.smart.android.demo.base.widget.AlertPickDialog;
import com.wiser.smart.android.demo.device.DpLogBean;
import com.wiser.smart.android.demo.base.utils.ProgressUtil;
import com.wiser.smart.android.demo.base.utils.ToastUtil;
import com.wiser.smart.android.demo.device.ICommonDeviceDebugView;
import com.wiser.smart.android.device.bean.EnumSchemaBean;
import com.wiser.smart.android.device.bean.SchemaBean;
import com.wiser.smart.android.device.enums.ModeEnum;
...
import com.wiser.smart.sdk.api.IWiserDevice;
...
public class CommonDeviceDebugPresenter extends BasePresenter implements IDevListener {
    ...
    private IWiserDevice mWiserDevice;
    ...
    private void initListener() {
        mWiserDevice = WiserHomeSdk.newDeviceInstance(mDevId);
        mWiserDevice.registerDevListener(this);
    }

    private void initData() {
        mDevId = ((Activity) mContext).getIntent().getStringExtra(INTENT_DEVID);
        mDevBean = WiserHomeSdk.getDataInstance().getDeviceBean(mDevId);
        if (mDevBean == null) {
...
//        }
        ...
        mWiserDevice.publishDps(commandStr, new IResultCallback() {
            @Override
    ...
    public void onDpUpdate(String devId, String dpStr) {
        ...
        DeviceBean deviceBean = WiserHomeSdk.getDataInstance().getDeviceBean(devId);
    ...
    public JSONObject getDpValueWithOutROMode(String devId, String value) {
        ...
        for (Map.Entry<String, Object> entry : jsonObject.entrySet()) {
            ...
            Map<String, SchemaBean> schema = WiserHomeSdk.getDataInstance().getSchema(devId);
            if (schema != null) {
    ...
    private void renameTitleToServer(final String titleName) {
        ...
        mWiserDevice.renameDevice(titleName, new IResultCallback() {
            @Override
            public void onError(String code, String error) {
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == DialogInterface.BUTTON_POSITIVE) {
                            ...
                            mWiserDevice.resetFactory(new IResultCallback() {
                                @Override
                                public void onError(String code, String error) {
                                    ProgressUtil.hideLoading();
    ...
    public void removeDevice() {
        ProgressUtil.showLoading(mContext, R.string.loading);
        mWiserDevice.removeDevice(new IResultCallback() {
            @Override
            public void onError(String code, String error) {
                ProgressUtil.hideLoading();
                ToastUtil.showToast(mContext, error);
...
//        mDownLatch = null;
        if (mWiserDevice != null) mWiserDevice.onDestroy();
