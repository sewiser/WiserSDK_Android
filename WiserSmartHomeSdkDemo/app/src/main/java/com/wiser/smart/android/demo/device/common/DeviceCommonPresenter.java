...
import com.wiser.smart.android.demo.device.DpSendPresenter;
import com.wiser.smart.android.demo.base.utils.ProgressUtil;
import com.wiser.smart.android.demo.base.utils.ToastUtil;
import com.wiser.smart.android.demo.device.IDeviceCommonView;
...
public class DeviceCommonPresenter extends BasePresenter {
    ...
    private List<SchemaBean> getSchemaList() {
        DeviceBean dev = WiserHomeSdk.getDataInstance().getDeviceBean(mDevId);
