package com.wiser.smart.android.demo.family;

import android.support.annotation.NonNull;
import android.util.Log;

import com.wiser.smart.android.demo.base.utils.CollectionUtils;
import com.wiser.smart.android.demo.family.event.EventCurrentHomeChange;
...
public class FamilyManager {
    ...
    public void getHomeList(@NonNull final IWiserGetHomeListCallback callback) {
    ...
    public void createHome(String homeName,
                           ...
                           @NonNull final IWiserHomeResultCallback callback) {
        WiserHomeSdk.getHomeManagerInstance().createHome(homeName,
                0, 0, "", roomList, new IWiserHomeResultCallback() {
                    @Override
