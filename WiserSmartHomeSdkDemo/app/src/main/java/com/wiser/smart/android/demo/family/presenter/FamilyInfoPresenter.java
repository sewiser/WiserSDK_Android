...
import com.wiser.smart.android.demo.family.activity.IFamilyInfoView;
import com.wiser.smart.android.demo.family.model.FamilyInfoModel;
import com.wiser.smart.android.demo.family.model.IFamilyInfoModel;
...
public class FamilyInfoPresenter extends BasePresenter {
    ...
    private void getHomeInfo() {
        mFamilyInfoModel.getHomeBean(mIFamilyInfoView.getHomeId(), new IWiserHomeResultCallback() {
            @Override
    ...
    private void getMemberInfo() {
        mFamilyInfoModel.getMemberList(mIFamilyInfoView.getHomeId(), new IWiserGetMemberListCallback() {
            @Override
