package com.wiser.smart.android.demo.family.view;
...
import com.wiser.smart.android.demo.base.utils.SizeUtils;
import com.wiser.smart.android.demo.family.FamilyManager;
import com.wiser.smart.android.demo.family.activity.FamilyIndexActivity;
import com.wiser.smart.android.demo.family.item.FamilyPopWindowItem;
...
public class FamilyDropActionSheet extends PopupWindow {
    ...
    private void initData() {
        FamilyManager.getInstance().getHomeList(new IWiserGetHomeListCallback() {
            @Override
