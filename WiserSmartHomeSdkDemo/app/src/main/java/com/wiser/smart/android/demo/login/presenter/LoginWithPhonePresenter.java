...
import com.wiser.smart.android.demo.login.ILoginWithPhoneView;
...
public class LoginWithPhonePresenter extends BasePresenter {
    ...
    public void getValidateCode() {
        mSend = true;
        WiserHomeSdk.getUserInstance().getValidateCode(mPhoneCode, mView.getPhone(), new IValidateCallback() {
            @Override
    ...
    public void login() {
        ...
        WiserHomeSdk.getUserInstance().loginWithPhone(mPhoneCode, phoneNumber, code, new ILoginCallback() {
            @Override
