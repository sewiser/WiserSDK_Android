package com.wiser.appsdk.sample.device.config.ble;
...
import com.wiser.smart.android.ble.api.BleConfigType;
import com.wiser.smart.android.ble.api.LeScanSetting;
import com.wiser.smart.android.ble.api.ScanDeviceBean;
import com.wiser.smart.android.ble.api.ScanType;
import com.wiser.smart.home.sdk.WiserHomeSdk;
import com.wiser.smart.home.sdk.bean.ConfigProductInfoBean;
import com.wiser.smart.sdk.api.IBleActivator;
import com.wiser.smart.sdk.api.IBleActivatorListener;
import com.wiser.smart.sdk.api.IMultiModeActivator;
import com.wiser.smart.sdk.api.IMultiModeActivatorListener;
import com.wiser.smart.sdk.api.IWiserActivator;
import com.wiser.smart.sdk.api.IWiserActivatorGetToken;
import com.wiser.smart.sdk.api.IWiserDataCallback;
import com.wiser.smart.sdk.bean.BleActivatorBean;
import com.wiser.smart.sdk.bean.DeviceBean;
import com.wiser.smart.sdk.bean.MultiModeActivatorBean;
...
public class DeviceConfigBleAndDualActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static IBleActivator mBleActivator = WiserHomeSdk.getActivator().newBleActivator();
    private static IMultiModeActivator mMultiModeActivator = WiserHomeSdk.getActivator().newMultiModeActivator();
    ...
    private void startScan() {
        ...
        // start scan
        WiserHomeSdk.getBleOperator().startLeScan(scanSetting, bean -> {
    ...
    private void stopScan() {
        WiserHomeSdk.getBleOperator().stopLeScan();
    }

    private void getDeviceInfo(ScanDeviceBean scanDeviceBean) {
        WiserHomeSdk.getActivatorInstance().getActivatorDeviceInfo(scanDeviceBean.getProductId(),
                scanDeviceBean.getUuid(),
                scanDeviceBean.getMac(),
                new IWiserDataCallback<ConfigProductInfoBean>() {
                    @Override
