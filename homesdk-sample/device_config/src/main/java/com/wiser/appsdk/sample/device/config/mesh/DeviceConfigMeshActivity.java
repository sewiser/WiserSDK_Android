package com.wiser.appsdk.sample.device.config.mesh;
...
import com.wiser.appsdk.sample.device.config.mesh.configByApp.SubConfigAppActivity;
import com.wiser.appsdk.sample.device.config.mesh.configByGateway.SubConfigGatewayActivity;
...
public class DeviceConfigMeshActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void createMesh() {
        WiserHomeSdk.newHomeInstance(HomeModel.getCurrentHome(this)).createSigMesh(new IWiserResultCallback<SigMeshBean>() {
            @Override
