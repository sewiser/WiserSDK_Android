package com.wiser.appsdk.sample.device.config.mesh.configByApp;
...
import com.wiser.smart.android.blemesh.api.IWiserBlueMeshActivatorListener;
import com.wiser.smart.android.blemesh.api.IWiserBlueMeshSearch;
import com.wiser.smart.android.blemesh.api.IWiserBlueMeshSearchListener;
import com.wiser.smart.android.blemesh.api.IWiserBlueMeshSearchListener;
import com.wiser.smart.android.blemesh.bean.SearchDeviceBean;
import com.wiser.smart.android.blemesh.builder.SearchBuilder;
import com.wiser.smart.android.blemesh.builder.WiserSigMeshActivatorBuilder;
import com.wiser.smart.home.sdk.WiserHomeSdk;
import com.wiser.smart.sdk.api.bluemesh.IWiserBlueMeshActivator;
...
public class SubConfigAppActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private IWiserBlueMeshSearch mMeshSearch;
    private IWiserBlueMeshActivator iWiserBlueMeshActivator;
    ...
    private void startScan() {
        ...
        SearchBuilder searchBuilder = new SearchBuilder()
                ...
                .setWiserBlueMeshSearchListener(new IWiserBlueMeshSearchListener() {
                    @Override
...
//                        getSubDeviceInfo(bean);
        ...
        mMeshSearch = WiserHomeSdk.getWiserBlueMeshConfig().newWiserBlueMeshSearch(searchBuilder);
        // start scan
    ...
    private void startActivator() {
        ...
        WiserSigMeshActivatorBuilder sigMeshActivatorBuilder = new WiserSigMeshActivatorBuilder()
                .setSearchDeviceBeans(searchDeviceBeanList)
                .setSigMeshBean(WiserHomeSdk.getSigMeshInstance().getSigMeshList().get(0))
                .setTimeOut(100)  // timeout: s
        ...
        iWiserBlueMeshActivator = WiserHomeSdk.getWiserBlueMeshConfig().newSigActivator(sigMeshActivatorBuilder);
        iWiserBlueMeshActivator.startActivator();
    }

    private void stopActivator() {
        if (iWiserBlueMeshActivator != null) {
