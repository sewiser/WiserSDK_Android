package com.wiser.appsdk.sample.device.config.qrcode;
...
public class QrCodeConfigActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private IWiserCameraDevActivator mWiserActivator;
            ...
            WiserHomeSdk.getActivatorInstance().getActivatorToken(homeId,
                    new IWiserActivatorGetToken() {
                        ...
                        public void onSuccess(String token) {
                            ...
                            mWiserActivator = WiserHomeSdk.getActivatorInstance().newCameraDevActivator(builder);
                            mWiserActivator.createQRCode();
