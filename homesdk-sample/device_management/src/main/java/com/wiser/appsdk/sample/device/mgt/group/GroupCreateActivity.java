...
import com.wiser.smart.android.network.http.BusinessResponse;
...
import com.wiser.smart.sdk.api.IWiserGroup;
import com.wiser.smart.sdk.api.bluemesh.IAddGroupCallback;
...
public class GroupCreateActivity extends AppCompatActivity {
        ...
        WiserHomeSdk.newHomeInstance(homeId).getHomeDetail(new IWiserHomeResultCallback() {
            ...
            public void onSuccess(HomeBean bean) {
                ...
                if (sigMeshBeans != null && !sigMeshBeans.isEmpty()) {
                    ...
                    List<DeviceBean> meshSubDevList = WiserHomeSdk.newSigMeshDeviceInstance(sigMeshBean.getMeshId()).getMeshSubDevList();
    ...
    void addGroup(String groupName) {
        new GroupBusiness().getSigMeshGroupLocalId(meshId, new Business.ResultListener<String>() {
            @Override
            public void onFailure(BusinessResponse businessResponse, String s, String s2) {
                Log.i(TAG, "get group localId ERROR:" + s + "/" + s2);
            }

            @Override
            public void onSuccess(BusinessResponse businessResponse, String localId, String s2) {
                int oldLocalId = Integer.parseInt(localId, 16);
                int newLocalId = oldLocalId + 0x4000;
                addGroup(groupName, String.format("%04x", newLocalId));
            }
        });
    }
    ...
    private void addGroup(String groupName, String localId) {
        ...
        mWiserSigMeshDevice.addGroup(groupName, pcc, localId, new IAddGroupCallback() {
            @Override
            public void onError(String errorCode, String errorMsg) {
                dismissProgressDialog();
                // create group failed
